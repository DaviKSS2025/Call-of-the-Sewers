...
public class CerberusStrategy : BaseStrategy, IEnemyStrategy
{
    private int _idleTurnChance;
    private string _name;
    public CerberusStrategy(AnimatorStateController enemyAnimatorController, int idleTurnChance, CombatChannel combatChannel, string name) : base(enemyAnimatorController, combatChannel)
    {
